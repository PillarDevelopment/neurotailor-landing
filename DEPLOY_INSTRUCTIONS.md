# Инструкции по деплою NeuroTailor Landing на Vercel
...
1. **Кастомный домен:**
   ...
   - Добавьте ваш домен (например, neurotailor.app)
...
🎉 Поздравляем! Ваш лендинг готов к запуску!